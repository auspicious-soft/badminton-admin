   ...
   <div className="flex gap-[15px] mt-[15px] md:flex-row flex-col ">
    ...
    <div>
     ...
     {/* <div className="flex justify-between mb-[20px]">
      ...
      <div className="rounded-[39px]  bg-white  px-[15px] py-[6px]  flex gap-[13px]  w-[193px] h-[25.41px] text-black/60 text-xs font-medium">
       <div className="border border-red-500 h-[25.41px] w-[25.41px] ">
        <Search />
       </div>
     ...
     <div className="mt-[15px] bg-[#f2f2f4] rounded-[20px] p-[14px] max-h-[400px] overflow-y-auto overflo-custom scrollbar-hide">
      {matches.map((match, index) => (
       <div key={match.id} className={`cursor-pointer flex items-center h-[47px] px-3.5 py-3 rounded-[10px] ${selectedMatch?.id === match.id ? "bg-[#176dbf] text-white" : index % 2 === 0 ? "bg-white" : "bg-gray-200"}`} onClick={() => setSelectedMatch(match)}>
        <div className={`w-1/4 flex items-center gap-2 text-xs font-medium ${selectedMatch?.id === match.id ? "text-white" : "text-[#1b2229]"}`}>
        ...
        <div className={`w-1/4 text-xs font-medium text-center ${selectedMatch?.id === match.id ? "text-white" : "text-[#1b2229]"}`}>{match.game}</div>
        <div className={`text-xs font-medium ${selectedMatch?.id === match.id ? "text-white" : "text-[#1b2229]"}`}>{match.date}</div>
        <div className="w-1/6 text-xs font-medium flex justify-center">
