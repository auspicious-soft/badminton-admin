...
export default function UsesComponent() {
...
<div className="flex flex-col w-full lg:w-1/3 gap-[24px] h-full justify-between ">
      ...
      <div className="w-full bg-[#f2f2f4] rounded-[20px] min-h-full">
       ...
       <div className="relative w-full pointer-events-none">
        <Image
         ...
         height={180} // Intrinsic height of the image
    ...
    <button onClick={handleClick} className="h-12  py-4 bg-[#10375c] rounded-[28px] justify-center items-center text-white text-sm font-medium ">View More Details</button>
