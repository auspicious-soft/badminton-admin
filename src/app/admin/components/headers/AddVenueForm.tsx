                                    ...
                                    <div className="flex gap-[10px] items-start">
                                        ...
                                        <div className="flex flex-col gap-[10px]">
                                            ...
                                            <div className="flex flex-col justify-start  gap-[5px]">
                                                ...
                                                <h4 className={`text-[10px] font-medium ${isActive ? ' text-[#1b2229]' : 'text-[#ff0004]'}`}>
                                                    {isActive ? 'Active' : 'Inactive'}
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    <button className="w-full rounded-[26px] bg-[#1C2329] text-white text-[10px] font-normal py-[8px] px-[12px]">
                                        Edit
                                    </button>
                                </div>
                            </div>
