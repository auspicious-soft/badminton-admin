   ...
   <div className="flex flex-col lg:flex-row bg-[#f2f2f4] rounded-[20px] p-4 gap-6">
    ...
    <div className="w-full lg:w-1/2 bg-white rounded-[20px] p-4 md:p-6">
     ...
     <div className="bg-[#f2f2f4] rounded-[10px] p-4 md:p-5 ">
        ...
        <div key={index} className="bg-white rounded-[10px] p-4">
         ...
         <div className="flex flex-wrap justify-center gap-2 md:gap-4 items-center">
          <div className="text-center">
           <Winner />
           <Image src={FirstImage} alt="first image" className="w-10 h-10 rounded-full object-cover mx-auto border border-yellow-400" />
          ...
          <div className="text-center">
           <Winner />
           <Image src={TwoImage} alt="second image" className="w-10 h-10 rounded-full object-cover mx-auto  border border-yellow-400" />
           <div className="text-white text-[8px] font-normal mt-1">2.1</div>
          ...
          <div className="text-center">
           <Image src={ThirdImage} alt="third image" className="w-10 h-10 rounded-full object-cover mx-auto" />
           <div className="text-white text-[8px] font-normal mt-1">2.1</div>
           <div className="text-[#5f6a7c] text-[10px] font-medium">Lorem</div>
          </div>

          <div className="text-center">
           <Image src={chanceAndBrandon} alt="fourth image" className="w-10 h-10 rounded-full object-cover mx-auto" />
           <div className="text-white text-[8px] font-normal mt-1">2.1</div>
      ...
      {/* Semi Finals Section */}
      <div className="text-[#1b2229] text-base md:text-lg font-semibold mt-[10px]">Semi Finals</div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
