...
//         setOpeningHours(venueData.openingHours);
//       }
...
//   // const venueData = {
//   //   venue: {
//   //     _id: '681c6bb7083d124cc5e35c63',
//   //     name: 'Aute quos ut et et a',
//   //     address: 'Cupiditate et cupidi',
//   //     city: 'Assumenda nostrud ve',
//   //     state: 'Assam',
//   //     image: 'blob:http://localhost:3000/4a154bb4-0e55-4296-8ece-a69e3f618fb6',
//   //     gamesAvailable: ['Pickleball'],
//   //     facilities: [
//   //       { name: 'Free Parking', isActive: false, _id: '681c6bb7083d124cc5e35c64' },
//   //       { name: 'Paid Parking', isActive: false, _id: '681c6bb7083d124cc5e35c65' },
//   //       { name: 'Rental Equipments', isActive: true, _id: '681c6bb7083d124cc5e35c66' },
//   //       { name: 'Locker Rooms & Changing Area', isActive: false, _id: '681c6bb7083d124cc5e35c67' },
//   //       { name: 'Restrooms & Showers', isActive: false, _id: '681c6bb7083d124cc5e35c68' },
//   //     ],
//   //     employees: [
//   //       {
//   //         employeeId: '6805cedf19a36ddcd969c990',
//   //         isActive: true,
//   //         employeeData: {
//   //           fullName: 'aaaaaaaaaaa',
//   //           email: 'xawu@mailinator.com',
//   //           phoneNumber: '3453453534',
//   //         },
//   //       },
//   //     ],
//   //     isActive: true,
//   //     venueInfo: 'No additional information present',
//   //     timeslots: [
//   //       '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00',
//   //       '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00',
//   //     ],
//   //     openingHours: [
//   //       { day: 'Monday', hours: ['03:22', '05:40'], _id: '681c6bb7083d124cc5e35c6a' },
//   //       { day: 'Tuesday', hours: ['06:14', '23:05'], _id: '681c6bb7083d124cc5e35c6b' },
//   //       { day: 'Wednesday', hours: ['06:50', '07:04'], _id: '681c6bb7083d124cc5e35c6c' },
//   //       { day: 'Thursday', hours: ['05:01', '15:03'], _id: '681c6bb7083d124cc5e35c6d' },
//   //       { day: 'Friday', hours: ['09:51', '11:50'], _id: '681c6bb7083d124cc5e35c6e' },
//   //       { day: 'Saturday', hours: ['12:31', '16:32'], _id: '681c6bb7083d124cc5e35c6f' },
//   //       { day: 'Sunday', hours: ['02:32', '12:00'], _id: '681c6bb7083d124cc5e35c70' },
//   //     ],
//   //     location: { type: 'Point', coordinates: [-8.93703957310157, 18.412219967630936] },
//   //     weather: { status: null, icon: null, temperature: null, lastUpdated: null },
//   //     createdAt: '2025-05-08T08:30:47.234Z',
//   //     updatedAt: '2025-05-08T08:30:47.234Z',
//   //     __v: 0,
//   //   },
//   //   courts: [
//   //     {
//   //       _id: '681c6bb7083d124cc5e35c72',
//   //       name: 'dasdasd',
//   //       venueId: '681c6bb7083d124cc5e35c63',
//   //       games: 'Padel',
//   //       isActive: true,
//   //       hourlyRate: 1200,
//   //       image: null,
//   //       __v: 0,
//   //       createdAt: '2025-05-08T08:30:47.293Z',
//   //       updatedAt: '2025-05-08T08:30:47.293Z',
//   //     },
//   //   ],
//   // };
...
//   // Map venueData to component state
//   useEffect(() => {
//     if (venueData && Object.keys(venueData).length > 0) {
...
//   // Map venueData to component state when venueData changes
//   useEffect(() => {
//     if (venueData && Object.keys(venueData).length > 0) {
//       setName(venueData.venue?.name || "");
//       setAddress(venueData.venue?.address || "");
...
//       setSelectedImage(venueData.venue?.image || null);
//     }
//   }, [venueData]); // Add venueData as a dependency
